 ...
 *   A form array.
 */
function netspective_common_settings($saved_settings, $subtheme_defaults = array()) {
  /*
  ...
  drupal_add_css(drupal_get_path('theme', 'netspective_common') . '/css/theme-settings.css', 'theme');

  // Add Javascript to adjust the layout on the settings page
  // drupal_add_js(drupal_get_path('theme', 'netspective_common') . '/css/theme-settings.js', 'theme');

  // Get the default values from the .info file.
  $defaults = netspective_common_theme_get_default_settings('netspective_common');
